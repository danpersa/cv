...
\begin{document}
    ...
    \begin{europecv}
     ...
     %   \ecvspace{-2.2cm} \tabularnewline
        ...
        \ccvitem{\textbf{{\large Nov 2019 $\longrightarrow$ Present}}}{\textbf{{\large Engineering Manager}}}
        ...
        \ccvitem{Merchant Success Tribe}{
          ...
          \begin{itemize}
            ...
            \item Delivered a redesigned, more customer friendly version of the help center
          \end{itemize}
        }
        \ccvitem{Lending Tribe}{
          \vspace{-12pt}
          \begin{itemize}
            \item Kicked off the tribe
            \item Lead a team of four engineers
            \item Started the Lending project from scratch and delivered the MVP
            \item Mentored one of the engineers, helping him becoming an Engineering Manager and taking over the Lending Squad
          \end{itemize}
        }
        \ccvitem{Web Platform Squad}{
          ...
          \begin{itemize}
            ...
            \item Focused on different projects like Accessibility
        ...
        \ccvitem{Consideration Squad}{
          ...
          \begin{itemize}
            ...
            \item Pushed forward performance related initiatives lowering the first contentful paint
          \end{itemize}
        }
        \ccvitem{Other Highlights}{
          ...
          \begin{itemize}
            ...
            \item  Introduced a continuous feedback process for the members of all my teams
