     ...
     %   \ecvspace{-2.2cm} \tabularnewline
        ...
        \ccvitem{Merchant Success Tribe}{
          ...
          \begin{itemize}
            ...
            \item Hired a Data Lead and a Salesforce Lead
            \item Helped an Engineer become Engineering Manager
            ...
            \item Acted as an interim lead for the Data Team
         ...
         \ccvitem{Other Highlights}{
          \vspace{-12pt}
          \begin{itemize}
            \item Together with a group of ~15 people, organized the SumUp Hack Week: an event having ~400 participants, in Portugal
          \end{itemize}
        }
        ...
        \ccvitem{Lending Tribe}{
          \vspace{-12pt}
          \begin{itemize}
            \item Lead a team of four engineers which started the Lending Project from scratch and delivered the MVP
        ...
        \ccvitem{Web Platform Squad}{
          ...
          \begin{itemize}
            ...
            \item Focused Accessibility, making sure customers with disabilities are able to easily access the SumUp products
        ...
        \ccvitem{Consideration Squad}{
          ...
          \begin{itemize}
            ...
            \item Pushed forward performance related initiatives lowering the first contentful paint and time to first byte
          \end{itemize}
        }
        \ccvitem{Other Highlights}{
          \vspace{-12pt}
