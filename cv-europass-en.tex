...
\begin{document}
    ...
    \begin{europecv}
     ...
     %   \ecvspace{-2.2cm} \tabularnewline
        ...
        \ccvitem{Employer}{Zalando (\weblink{http://www.zalando.de}), Berlin, Germany}
        \ccvitem{Highlights}{
          \vspace{-12pt}
          \begin{itemize}
            ...
            \item Share knowledge through Tech Talks, Workshops, Reading Groups
          \end{itemize}
        }
        \ccvitem{Projects}{Shop Filters API
          \begin{itemize}
            ...
            \item Organize the team, so we can work as efficiently as possible
          \end{itemize}
        ...
        \ccvitem{Contributions}{As part of the Catalog and Navigation team:
          \begin{itemize}
          ...
          \begin{itemize}
            ...
            \item Organize monthly workshops about web services and REST
            \item Give a tech talk about Acceptance Testing and one about Code Refactoring
            \item Organize two Coder Dojos
...
IACS (Integrated Administration and Control System) makes it possible to develop direct and indirect (data warehouse for animals, land, applicants, control and administration processes) system modules. It constitutes the basis for agricultural grants from the EU.
        ...
        \ccvitem{Job Related Skills}{
            ...
            \begin{itemize}
              ...
              \item Programming Languages - Intermediate: Ruby, SQL
