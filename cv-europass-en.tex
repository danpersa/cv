     ...
     %   \ecvspace{-2.2cm} \tabularnewline
        ...
        \ccvitem{Highlights}{
          ...
          \begin{itemize}
            ...
            \item Work on software accessed by hundreds of users per second
            \item Design a new database for the Article Reviews project
          \end{itemize}
        }
        \ccvitem{Projects}{Filter Refactoring
          \begin{itemize}
          ...
          \begin{itemize}
            ...
            \item Work with Solr for indexing the reviews
             \item Write unit tests, integration tests and acceptance tests using Cucumber
          \end{itemize}

          \bigskip As part of the Mentoring Team:
          \begin{itemize}
            \item Give monthly presentations about the Google Guava library
            \item Organize monthly workshops about web services
          \end{itemize}
        ...
        \ccvitem{Used technologies \& tools:}{
          \vspace{-12pt}
          \begin{itemize}
            \item Technologies: Spring MVC, Spring Core, Guava, Solr4J, JUnit, Mockito, JAX-RS, SOAP, Cucumber
            \item Web Server: Tomcat 7
            \item IDE: IntelliJ
            \item Database: PostgreSQL
            \item Full text search: Solr
            \item Build management and testing: Maven,
            \item Revision control: Git -> Atlassian Stash
        ...
        \ccvitem{Used technologies \& tools:}{
          \vspace{-12pt}
          \begin{itemize}
            \item Technologies: Spring MVC, Spring Core, Hibernate, Jersy, RESTEasy, SOAP, WDSL, JUnit, Mockito
...
IACS (Integrated Administration and Control System) makes it possible to develop direct and indirect (data warehouse for animals, land, applicants, control and administration processes) system modules. It constitutes the basis for agricultural grants from the EU.
        ...
        \ccvitem{Job Related Skills}{
            ...
            \begin{itemize}
              ...
              \item Java Testing: JUnit, TestNG, Mockito
              \item Indexing: Solr, ElasticSearch
