...
\begin{document}
    ...
    \begin{europecv}
     ...
     %   \ecvspace{-2.2cm} \tabularnewline
        ...
        % Work Experience @ Zalando
        \ccvitem{\textbf{{\large May 2013 $\longrightarrow$ Present}}}{\textbf{{\large Software Engineer}}}
        \ccvitem{Employer}{
        ...
        \ccvitem{Contributions}{
          ...
          \begin{itemize}
            ...
            \item Organize several \href{https://github.com/zalando-incubator/coder-dojo}{Coder Dojos}
            \item Organize \href{http://tech.zalando.com/posts/reading-groups-at-zalando.html}{reading groups} with weekly meetups
          \end{itemize}
        ...
        \ccvitem{Projects}{
          ...
          \begin{itemize}
            ...
            \item Promoted the architecture outside of Zalando, in a series of \href{https://tech.zalando.com/blog/?tags=mosaic}{blog posts} and \href{https://www.youtube.com/watch?v=g-s46Ewh-zo}{tech talks}.
          \end{itemize}
          ...
          \begin{itemize}
            ...
            \item The service is able to resize and crop images on the fly.
          \end{itemize}
...
IACS (Integrated Administration and Control System) makes it possible to develop direct and indirect (data warehouse for animals, land, applicants, control and administration processes) system modules. It constitutes the basis for agricultural grants from the EU.
        ...
        \ccvitem{Tech Talks}{
            \vspace{-12pt}
            \begin{itemize}
                \item \href{http://berlin2015.codemotionworld.com/speaker/1650/}{Codemotion Berlin 2015}
                \item \href{https://www.youtube.com/watch?v=g-s46Ewh-zo}{Microservices Meetup Munich}
                \item \href{https://www.youtube.com/watch?v=-TlzifWo5Ss}{Code Talks 2016}
            \end{itemize}
        }
        ...
        \ccvitem{Computer Skills}{
            \vspace{-12pt}
            \begin{itemize}
              \item Microsoft Word, PowerPoint, Excel, Outlook, Lotus, OpenOffice
              \item Photoshop, Flash, Dreamwaver, Corel Draw, Adobe Lightroom
