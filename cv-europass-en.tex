...
\begin{document}
    ...
    \begin{europecv}
     ...
     %   \ecvspace{-2.2cm} \tabularnewline
        ...
        \ccvitem{\textbf{{\large March 2017 $\longrightarrow$ Sept 2017}}}{\textbf{{\large Engineering Manager, Fashion Store Department}}}
        ...
        \ccvitem{Highlights}{
          ...
          \begin{itemize}
            ...
            \item Responsible for delivery, architecture, hiring, enabling team autonomy, continuous improvement, people management and career development
        ...
        \ccvitem{\textbf{{\large March 2017 $\longrightarrow$ Sept 2017}}}{\textbf{{\large Delivery Lead, Brand Solutions Department}}}
        \ccvitem{Employer}{Zalando (\weblink{https://tech.zalando.com/}), Berlin, Germany), Berlin, Germany}
        \ccvitem{Highlights}{
          \vspace{-12pt}
          \begin{itemize}
            \item Lead four teams, 20 people in total, being responsible for delivery, architecture, hiring, enabling team autonomy and continuous improvement of the team
            \item Starting June be responsible for people management and career development for the members of the team
            ...
            \item Hire a new developer
          \end{itemize}
        }

        % Work Experience @ Zalando as Co Delivery Lead
        \ccvitem{\textbf{{\large Sept 2016 $\longrightarrow$ March 2017}}}{\textbf{{\large Co Delivery Lead, Brand Solutions Department}}}
        \ccvitem{Employer}{Zalando (\weblink{https://tech.zalando.com/}), Berlin, Germany}
        \ccvitem{Highlights}{
          \vspace{-12pt}
          \begin{itemize}
            \item Last part of the Tour of Mastery to become a Delivery Lead
        ...
        \ccvitem{\textbf{{\large May 2013 $\longrightarrow$ Sept 2016}}}{\textbf{{\large Software Engineer, Fashion Store Department}}}
        \ccvitem{Employer}{
...
It is developed using the Agile methodologies, in thirty iterations, during a period of an year and a half.
        ...
        \tabularnewline
        \ccvitem{\textbf{{\large Aug 2008 $\longrightarrow$ Sept 2009}}}{\textbf{{\large Software Engineer}}}
...
IACS (Integrated Administration and Control System) makes it possible to develop direct and indirect (data warehouse for animals, land, applicants, control and administration processes) system modules. It constitutes the basis for agricultural grants from the EU.
        ...
        \tabularnewline
        \ccvitem{\textbf{{\large July 2005 $\longrightarrow$ Sept 2007}}}{\textbf{{\large Software Engineer}}}
        ...
        \tabularnewline
        \ccvitem{\textbf{{\large 2000 $\longrightarrow$ 2004}}}{\textbf{{\large Ovidius High School, Constanta}}}

        \tabularnewline

        % Personal Skills and Competences

        \ccvsection{skills}{Personal Skills}
        ...
        \ccvitem{Communication Skills}{
          \vspace{-12pt}
          \begin{itemize}
                 \item Good ability to work individually or as a team with a strong sense of responsibility on any of the situations
                \item Excellent communication skills, gained through working with the testing teams and upper management
                \item Ability to respond well under pressure preserving a professional rigor
                \item Good ability to adapt to multicultural environments, gained through working in international teams
            \end{itemize}
        }

        \ccvitem{Organizational Skills and Competences}{
            \vspace{-12pt}
            \begin{itemize}
        ...
        \ccvitem{Job Related Skills}{
            \vspace{-12pt}
            \begin{itemize}
              \item Programming Languages - Advanced: Java
              \item Programming Languages - Intermediate: Scala, Clojure, Ruby, SQL
              \item Other technologies: CSS, JavaScript, HTML, UML, XML, Maven
              \item Database Management Systems: PostgreSQL, Oracle, IBM DB2, Couchbase, MongoDB
              \item Version Control Systems: Git and Subversion
              \item Java Related: Spring, Hibernate, JPA, JSF, RESTlet, JAX-RS, Solr, Guava, EJB, JBoss Seam
              \item Java Frontend: Spring MVC, GWT, Freemarker
              \item Java Testing: JUnit, TestNG, Mockito, Cucumber
              \item Full text search: Solr, ElasticSearch
              \item Application Servers: WebSphere Application Server, WebSphere Portal 6.0, JBoss 5.x
              \item Web Servers: Tomcat, Jetty
            \end{itemize}
         }
